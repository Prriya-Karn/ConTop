    ...
    return (
        <Fragment>
            ...
            <section className="main-homepage-1 d-flex align-items-center overflow-x-hidden">
                ...
                <button className="qual-my-pro btn" style={{backgroundColor:(pro===true)?"#C53183":"#D9D9D966",
                    color : pro==true?"white":"black"
                }}
                onClick={myProfile}>My Profile</button>




                                <button className="qual-my-quali btn"
                                 onClick={Myqua} style={{backgroundColor:(pro===false)?"#C53183":"#D9D9D966",
                                    color : pro==false?"white":"black"
                                }}
                                 >
                           ...
                           { 
                            ...
                            <div className="qual-prof-quali d-flex">
                                ...
                                <button className="btn" style={{backgroundColor:"#C53183"}}
                                ...
                                <div className="modal-dialog modal-home-dialog modal-dialog-centered">
                                    <div className="modal-content main-home-modal main-myqual-modal main-myqual-modal-another" style={{ borderRadius: "20px", width: "667px", height: "436px" }}>
                                        ...
                                        <form>
                                            ...
                                            <div className="qual-prof-quali edu-qua d-flex">
